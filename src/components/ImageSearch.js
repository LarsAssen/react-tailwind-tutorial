    ...
    return (
        <div className="max-w-sm rounded overflow-hidden my-10 mx-auto">
            ...
            <div className="flex items-center border-b border-b-2 border-green-500 py-2">
                ...
                <button className="flex-shrink-0 bg-green-500 hover:bg-green-700 border-green-500 hover:border-green-700 tx-sm border-4 text-white py-1 px-2 rounded" type="submit">Search</button>
            </div>
            </form>
        </div>
    )
